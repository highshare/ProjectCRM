...
import pl.mwa.ProjectCrMbyMwaApplication;


@SpringBootTest(classes = {ProjectCrMbyMwaApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
